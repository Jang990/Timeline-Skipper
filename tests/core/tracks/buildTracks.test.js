...
describe('buildTracks', () => {
  ...
  it('항목에 적힌 끝 시각은 읽지 않는다', () => {
    const entries = [
      { timestampSeconds: 10, endSeconds: 50, title: '끝을 적어둔 곡' },
    ...
    expect(result).toEqual([
      { startSeconds: 10, endSeconds: 100, title: '끝을 적어둔 곡' },
      { startSeconds: 100, endSeconds: 300, title: '다음 곡' }
    ])
  })
