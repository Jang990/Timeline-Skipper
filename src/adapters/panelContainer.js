...
export function findPanelContainer() {
  ...
  const narrowContainer = document.querySelector(SELECTORS.narrowPanelContainer)

  if (!isTwoColumns && narrowContainer !== null) {
    return narrowContainer
  }

  return document.querySelector(SELECTORS.panelContainer)
}
