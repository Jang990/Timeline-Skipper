...
const LINE_ICONS = {
  ...
  tune: ['M4 7h9', 'M17 7h3', 'M4 17h3', 'M11 17h9', 'M13 7a2 2 0 1 0 4 0a2 2 0 1 0-4 0', 'M7 17a2 2 0 1 0 4 0a2 2 0 1 0-4 0'],
  ...
  // X 위로 넘어가는 화살표. 바로 옆 ⏭과 구별되면서, 해제한 트랙을 건너뛴다는 동작을 그대로 그린다.
  'skip-track': ['M3 15c2-6 5-9 9-9s7 3 9 9', 'M17.5 13.5l3.5 1.5 1.2-3.6', 'M9.5 15l5 5', 'M14.5 15l-5 5']
}
...
const FILLED_ICONS = {
  ...
  grip: [
    'M7.5 5a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0-3 0',
    'M13.5 5a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0-3 0',
    'M7.5 12a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0-3 0',
    'M13.5 12a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0-3 0',
    'M7.5 19a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0-3 0',
    'M13.5 19a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0-3 0'
  ]
}
